...
prices <- "/home/hduser/Desktop/R/prices.csv"
...
write.table(df, "/home/hduser/Desktop/R/result1.txt", sep=",", col.names = FALSE, row.names = FALSE)
...
# Write results into a destination file
write.table(result, "/home/hduser/Desktop/R/result2.txt", sep=" ", col.names = FALSE, row.names = FALSE)
